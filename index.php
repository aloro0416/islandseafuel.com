    ...
    <div class="text-center">
     ...
     <form method="post" action="auth.php" class="clearfix" id="loginForm">
        <div class="form-group">
              ...
              <input type="name" class="form-control" name="username" id="username" placeholder="Username" <?php if (isset($_SESSION['lockout_time']) && time() < $_SESSION['lockout_time']): ?>>
        </div>
        <div class="form-group">
            <label for="Password" class="control-label">Password</label>
            <input type="password" name= "password" class="form-control" id="myInput" placeholder="Password" <?php if (isset($_SESSION['lockout_time']) && time() < $_SESSION['lockout_time']): ?>>
        ...
        <div class="form-group">
            <button type="submit" id="btn-login" class="btn btn-danger" style="border-radius:0%" <?php if (isset($_SESSION['lockout_time']) && time() < $_SESSION['lockout_time']): ?>>Login</button>
        </div>
        <div class="text-center">
